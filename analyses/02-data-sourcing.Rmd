...
write_rds("data-raw/nyt/nyt_raw.Rds")
write_csv("data-raw/nyt/nyt_raw.csv")
```
...
```{r}
write_rds("data/nyt/nyt.Rds")
write_csv("data/nyt/nyt.csv")
```
...
write_rds("data/supplement/measures.Rds")
write_csv("data/supplement/measures.csv")
```
